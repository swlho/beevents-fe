  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        selected:
          'bg-blue-500 text-primary-foreground hover:bg-blue-500 hover:text-primary-foreground focus:bg-blue-500 focus:text-primary-foreground rounded-l-md rounded-r-md',
        today: 'bg-yellow-500 text-accent-foreground',
        outside:
